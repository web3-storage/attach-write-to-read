...
export class NoSuccessResponseError extends HTTPError {
  constructor (msg = 'No success response to pull CAR from') {
    super(msg, 404)
    this.name = 'NoSuccessResponse'
    this.code = NoSuccessResponseError.CODE
  }
}
NoSuccessResponseError.CODE = 'ERROR_NO_VALID_URL'
